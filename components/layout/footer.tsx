...
export const Footer = () => {
  return (
    <>
      <div className="relative md:h-[23dvh] lg:h-[27dvh] text-neutral-400 bg-neutral-800 dark:bg-neutral-700 py-1">
        <div className="flex flex-col lg:flex-row gap-8 justify-between h-full px-10">
          <div className="md:flex gap-8 items-start pt-10 ml-5">
            <Link href="/">
              <LogoText />
            </Link>
            <div className="flex flex-col sm:flex-row sm:gap-8 h-5 mt-3 pb-32 sm:pb-0">
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1" className="border-0">
                  <AccordionTrigger className="py-0 border-0">
                    Top Lists
                  </AccordionTrigger>
                  <AccordionContent>
              ...
              <Separator
                ...
                className="hidden sm:block dark:bg-neutral-400"
              />
        ...
        <div className="text-neutral-400 bg-neutral-800 dark:bg-neutral-700 px-10">
          ...
          <p className="text-center text-xs py-3">
            Copyright © 2023 ZORANIME, All rights reserved.
          </p>
        </div>
      </div>
    </>
